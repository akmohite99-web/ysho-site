...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-24">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-16 items-center">
            <div className="animate-fade-in">
              <Badge variant="secondary" className="mb-6 bg-warm-brown/10 text-warm-brown border-warm-brown/20">
                <Sparkles className="w-4 h-4 mr-2" />
                Premium A2 Bilona Ghee
              </Badge>
              <h1 className="text-5xl lg:text-6xl font-bold mb-2 leading-tight">
                <span className="text-warm-brown">Ysho</span>{" "}
              ...
              <p className="text-xl lg:text-2xl font-medium text-muted-foreground mb-6">
                ...
                <span className="text-warm-brown">Golden</span>
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <Star key={star} className="w-5 h-5 fill-warm-brown text-warm-brown" />
                  ))}
      ...
      <section id="benefits" className="py-24 bg-gradient-to-b from-background to-cream">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-slide-up">
            <Badge variant="outline" className="mb-4 border-warm-brown text-warm-brown">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-golden-light via-golden to-golden-dark text-warm-brown">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button variant="secondary" size="xl" className="bg-white text-warm-brown hover:bg-cream">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-8">
                <Phone className="w-12 h-12 text-warm-brown mx-auto mb-4 group-hover:animate-float" />
                <h3 className="text-xl font-semibold mb-2">Call Us</h3>
                <p className="text-muted-foreground mb-4">Speak with our team</p>
                <p className="font-semibold text-warm-brown">+91 90492 99369</p>
              </CardContent>
            </Card>

            <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-8">
                <Mail className="w-12 h-12 text-warm-brown mx-auto mb-4 group-hover:animate-float" />
                <h3 className="text-xl font-semibold mb-2">Email Us</h3>
                <p className="text-muted-foreground mb-4">Send us a message</p>
                <p className="font-semibold text-warm-brown">care@ysho.in</p>
              </CardContent>
            </Card>

            <Card className="text-center group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-8">
                <MapPin className="w-12 h-12 text-warm-brown mx-auto mb-4 group-hover:animate-float" />
                <h3 className="text-xl font-semibold mb-2">Visit Us</h3>
                <p className="text-muted-foreground mb-4">Our dairy farm</p>
                <p className="font-semibold text-warm-brown text-sm">Bahula Go Dham Organics<br/>Sasvand, At. Punjave, Post - Dhundalwadi<br/>Tal - Dahanu, Dist - Palghar-401606</p>
              </CardContent>
            </Card>
          </div>
        </div>
